            ...
            <div className='grid grid-cols-[48px,1fr] gap-4'>
                ...
                <div className='w-[90%]'>
                    <textarea
                        ...
                        rows="2"
                        placeholder="What's Happening Guy's?"
                        value={input}
                    ...
                    {!loading && (
                        <div className='flex justify-between items-center'>
                            ...
                            <button
                                className="bg-blue-500 text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#1a8cd8] disabled:hover:bg-[#1d9bf0] disabled:opacity-50 disabled:cursor-default"
