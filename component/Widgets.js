  ...
  return (
    ...
    <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50">
      <div className="flex items-center p-3 rounded-full  relative">
        <BsSearch className="h-6 z-50 text-gray-500" />
        <input
    ...
    <div className="sticky top-16 text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%]">
        ...
        {randomUsersResults.slice(0,randomUserNum).map((randomUser)=>(
            <div className="flex items-center px-4 py-2  cursor-pointer hover:bg-gray-200 transition duration-500 ease-out" key={randomUser.login.username}>
