  ...
  return (
    <div className='hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full border-r border-gray-400 pr-0 xl:pr-8'>
         <div className='flex items-center justify-center w-14 h-14 hoverEffect p-0 xl:ml-24'>
                <BsTwitter className='text-blue-400 text-[34px]' />
            </div>
            ...
            <div
                className="text-black-600 flex items-center justify-center mt-auto hoverEffect xl:ml-auto xl:-mr-5 px-4 py-2 "
                onClick={signOut}
            >
                <img
                ...
                <div className="hidden xl:inline leading-5">
                    ...
                    <p className="text-black-600">@{session?.user?.tag}</p>
                </div>
